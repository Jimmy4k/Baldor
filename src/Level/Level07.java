...
public class Level07 extends JPanel {
	...
	public Level07(GameManager gm) {
		...
		gm.setLastPanel("Level07");

		gm.getHud().hud(gm, p);
		gm.getHud().insertTrank(gm, p, 3, "Heiltrank", 25);
		System.out.println ("Tränke :" + gm.getPlayer().getTrankBag().size());
		...
		btnWeiter.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				...
				Level08 level08 = new Level08(gm);
				gm.getLayeredPane().add(level08, "Level08");
				gm.getLevelSwitcher().switchPanel(gm.getCardLayout(), gm.getLayeredPane(), "Level08");
			}			@Override
