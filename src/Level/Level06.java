...
public class Level06 extends JPanel {
	...
	public Level06(GameManager gm) {
		...
		JLabel lblBegrüßung = new JLabel("<html><body>Und bevor ich es vergesse..." + gm.getPlayer().getName() + " Nimm auch diese Tränke von mir, sie werden dir in schwachen Momenten wieder Kraft schenken.<body><html>");
